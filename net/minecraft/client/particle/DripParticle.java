...
public class DripParticle extends TextureSheetParticle {
   ...
   static class FallingParticle extends DripParticle {
      ...
      // $FF: synthetic method
      FallingParticle(ClientLevel var1, double var2, double var4, double var6, Fluid var8, int var9, Object var10) {
   ...
   static class DripstoneFallAndLandParticle extends DripParticle.FallAndLandParticle {
      ...
      // $FF: synthetic method
      DripstoneFallAndLandParticle(ClientLevel var1, double var2, double var4, double var6, Fluid var8, ParticleOptions var9, Object var10) {
         this(var1, var2, var4, var6, var8, var9);
      }
   }
