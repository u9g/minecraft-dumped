...
public class CycleButton<T> extends AbstractButton implements TooltipAccessor {
   ...
   private void updateValue(T var1) {
      Object var2 = this.displayOnlyValue ? (Component)this.valueStringifier.apply(var1) : this.createFullName(var1);
      this.setMessage((Component)var2);
      this.value = var1;
   }
   ...
   // $FF: synthetic method
   CycleButton(int var1, int var2, int var3, int var4, Component var5, Component var6, int var7, Object var8, CycleButton.ValueListSupplier var9, Function var10, Function var11, CycleButton.OnValueChange var12, CycleButton.TooltipSupplier var13, boolean var14, Object var15) {
