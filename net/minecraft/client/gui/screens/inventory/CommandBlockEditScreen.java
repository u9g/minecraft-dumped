...
public class CommandBlockEditScreen extends AbstractCommandBlockEditScreen {
   ...
   protected void init() {
      super.init();
      this.modeButton = (CycleButton)this.addButton(CycleButton.builder((var0) -> {
         switch(var0) {
         case SEQUENCE:
