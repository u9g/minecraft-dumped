...
public class SkinCustomizationScreen extends OptionsSubScreen {
   ...
   protected void init() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         this.addButton(CycleButton.onOffBuilder(this.options.isModelPartEnabled(var5)).create(this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 + 24 * (var1 >> 1), 150, 20, var5.getName(), (var2x, var3x) -> {
            this.options.toggleModelPart(var5, var3x);
         }));
         ++var1;
      }

      this.addButton(Option.MAIN_HAND.createButton(this.options, this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 + 24 * (var1 >> 1), 150));
      ++var1;
      if (var1 % 2 == 1) {
         ++var1;
      }
