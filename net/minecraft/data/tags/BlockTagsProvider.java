...
public class BlockTagsProvider extends TagsProvider<Block> {
   ...
   protected void addTags() {
      ...
      this.tag(BlockTags.LEAVES).add((Object[])(Blocks.JUNGLE_LEAVES, Blocks.OAK_LEAVES, Blocks.SPRUCE_LEAVES, Blocks.DARK_OAK_LEAVES, Blocks.ACACIA_LEAVES, Blocks.BIRCH_LEAVES, Blocks.AZALEA_LEAVES, Blocks.AZALEA_LEAVES_FLOWERS));
      ...
      this.tag(BlockTags.BASE_STONE_OVERWORLD).add((Object)Blocks.STONE).add((Object)Blocks.GRANITE).add((Object)Blocks.DIORITE).add((Object)Blocks.ANDESITE).add((Object)Blocks.GRIMSTONE);
