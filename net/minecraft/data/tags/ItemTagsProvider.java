...
public class ItemTagsProvider extends TagsProvider<Item> {
   ...
   protected void addTags() {
      ...
      this.tag(ItemTags.STONE_TOOL_MATERIALS).add((Object[])(Items.COBBLESTONE, Items.BLACKSTONE, Items.GRIMSTONE));
      this.tag(ItemTags.STONE_CRAFTING_MATERIALS).add((Object[])(Items.COBBLESTONE, Items.BLACKSTONE, Items.GRIMSTONE));
      this.tag(ItemTags.FREEZE_IMMUNE_WEARABLES).add((Object[])(Items.LEATHER_BOOTS, Items.LEATHER_LEGGINGS, Items.LEATHER_CHESTPLATE, Items.LEATHER_HELMET));
      this.tag(ItemTags.AXOLOTL_TEMPT_ITEMS).add((Object[])(Items.TROPICAL_FISH, Items.TROPICAL_FISH_BUCKET));
   }
