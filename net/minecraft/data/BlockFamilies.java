...
public class BlockFamilies {
   ...
   public static final BlockFamily GRIMSTONE;
   public static final BlockFamily POLISHED_GRIMSTONE;
   public static final BlockFamily GRIMSTONE_TILES;
   public static final BlockFamily GRIMSTONE_BRICKS;
   ...
   static {
      ...
      WAXED_EXPOSED_CUT_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
      ...
      WAXED_WEATHERED_CUT_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
      OXIDIZED_CUT_COPPER = familyBuilder(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).getFamily();
      ...
      SANDSTONE = familyBuilder(Blocks.SANDSTONE).wall(Blocks.SANDSTONE_WALL).stairs(Blocks.SANDSTONE_STAIRS).slab(Blocks.SANDSTONE_SLAB).chiseled(Blocks.CHISELED_SANDSTONE).dontGenerateRecipe().getFamily();
      ...
      GRIMSTONE = familyBuilder(Blocks.GRIMSTONE).slab(Blocks.GRIMSTONE_SLAB).stairs(Blocks.GRIMSTONE_STAIRS).chiseled(Blocks.CHISELED_GRIMSTONE).polished(Blocks.POLISHED_GRIMSTONE).wall(Blocks.GRIMSTONE_WALL).getFamily();
      POLISHED_GRIMSTONE = familyBuilder(Blocks.POLISHED_GRIMSTONE).slab(Blocks.POLISHED_GRIMSTONE_SLAB).stairs(Blocks.POLISHED_GRIMSTONE_STAIRS).wall(Blocks.POLISHED_GRIMSTONE_WALL).getFamily();
      GRIMSTONE_TILES = familyBuilder(Blocks.GRIMSTONE_TILES).slab(Blocks.GRIMSTONE_TILE_SLAB).stairs(Blocks.GRIMSTONE_TILE_STAIRS).wall(Blocks.GRIMSTONE_TILE_WALL).getFamily();
      GRIMSTONE_BRICKS = familyBuilder(Blocks.GRIMSTONE_BRICKS).slab(Blocks.GRIMSTONE_BRICK_SLAB).stairs(Blocks.GRIMSTONE_BRICK_STAIRS).wall(Blocks.GRIMSTONE_BRICK_WALL).getFamily();
   }
}
