...
public class BlockModelGenerators {
   ...
   private final List<Block> mirroredFullBlocks;
   ...
   public BlockModelGenerators(Consumer<BlockStateGenerator> var1, BiConsumer<ResourceLocation, Supplier<JsonElement>> var2, Consumer<Item> var3) {
      ...
      this.mirroredFullBlocks = ImmutableList.of(Blocks.STONE, Blocks.GRIMSTONE);
      ...
      })).put(Blocks.QUARTZ_BLOCK, TexturedModel.COLUMN.get(Blocks.QUARTZ_BLOCK)).put(Blocks.SMOOTH_QUARTZ, TexturedModel.createAllSame(TextureMapping.getBlockTexture(Blocks.QUARTZ_BLOCK, "_bottom"))).put(Blocks.BLACKSTONE, TexturedModel.COLUMN_WITH_WALL.get(Blocks.BLACKSTONE)).build();
   ...
   private void createSmallDripleaf() {
      ...
      this.delegateItemModel(Blocks.SMALL_DRIPLEAF, var1);
      List var3 = Arrays.asList(createRotatedVariants(var1));
      List var4 = Arrays.asList(createRotatedVariants(var2));
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SMALL_DRIPLEAF).with(PropertyDispatch.property(BlockStateProperties.DOUBLE_BLOCK_HALF).select(DoubleBlockHalf.LOWER, (List)var4).select(DoubleBlockHalf.UPPER, (List)var3)));
   }
   ...
   private void createCaveVines() {
      ResourceLocation var1 = this.createSuffixedVariant(Blocks.CAVE_VINES_HEAD, "", ModelTemplates.CROSS, TextureMapping::cross);
      ResourceLocation var2 = this.createSuffixedVariant(Blocks.CAVE_VINES_HEAD, "_lit", ModelTemplates.CROSS, TextureMapping::cross);
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CAVE_VINES_HEAD).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, var2, var1)));
      ResourceLocation var3 = this.createSuffixedVariant(Blocks.CAVE_VINES_BODY, "", ModelTemplates.CROSS, TextureMapping::cross);
      ResourceLocation var4 = this.createSuffixedVariant(Blocks.CAVE_VINES_BODY, "_lit", ModelTemplates.CROSS, TextureMapping::cross);
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CAVE_VINES_BODY).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, var4, var3)));
   }
   ...
   class BlockFamilyProvider {
      ...
      public BlockModelGenerators.BlockFamilyProvider fullBlock(Block var1, ModelTemplate var2) {
         ...
         if (BlockModelGenerators.this.mirroredFullBlocks.contains(var1)) {
            ResourceLocation var3 = ModelTemplates.CUBE_MIRRORED_ALL.create(var1, this.mapping, BlockModelGenerators.this.modelOutput);
