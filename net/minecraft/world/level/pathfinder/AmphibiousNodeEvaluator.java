   ...
   private Node getAcceptedNode(int var1, int var2, int var3, int var4, double var5) {
      ...
      if (var9 - var5 > 1.125D) {
         ...
         if (var11 != BlockPathTypes.WATER && var11 != BlockPathTypes.WALKABLE) {
            ...
            if (this.prefersShallowSwimming && var2 < this.mob.level.getSeaLevel() - 10 && var7 != null) {
               ++var7.costMalus;
            }
   ...
   public BlockPathTypes getBlockPathType(BlockGetter var1, int var2, int var3, int var4) {
      ...
      if (var6 == BlockPathTypes.WATER) {
         ...
         if (var6 == BlockPathTypes.OPEN && var3 >= var1.getMinBuildHeight() + 1) {
            var5.set(var2, var3, var4).move(Direction.DOWN);
            BlockState var7 = var1.getBlockState(var5);
            BlockPathTypes var8 = getBlockPathTypeRaw(var1, var5);
