...
public class PillagerOutpostFeature extends JigsawFeature {
   ...
   protected boolean isFeatureChunk(ChunkGenerator var1, BiomeSource var2, long var3, WorldgenRandom var5, int var6, int var7, Biome var8, ChunkPos var9, JigsawConfiguration var10, LevelHeightAccessor var11) {
      int var12 = SectionPos.blockToSectionCoord(var6);
      int var13 = SectionPos.blockToSectionCoord(var7);
      var5.setSeed((long)(var12 ^ var13 << 4) ^ var3);
      var5.nextInt();
      if (var5.nextInt(5) != 0) {
         return false;
      } else {
