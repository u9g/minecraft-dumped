...
public class JigsawFeature extends StructureFeature<JigsawConfiguration> {
   ...
   public static class FeatureStart extends NoiseAffectingStructureStart<JigsawConfiguration> {
      ...
      public void generatePieces(RegistryAccess var1, ChunkGenerator var2, StructureManager var3, int var4, int var5, Biome var6, JigsawConfiguration var7, LevelHeightAccessor var8) {
         BlockPos var9 = new BlockPos(SectionPos.sectionToBlockCoord(var4), this.feature.startY, SectionPos.sectionToBlockCoord(var5));
         Pools.bootstrap();
         JigsawPlacement.addPieces(var1, var7, PoolElementStructurePiece::new, var2, var3, var9, this.pieces, this.random, this.feature.doExpansionHack, this.feature.projectStartToHeightmap, var8);
