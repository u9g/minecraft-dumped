...
public class Aquifer {
   ...
   public Aquifer(int var1, int var2, NormalNoise var3, NormalNoise var4, NoiseGeneratorSettings var5, NoiseSampler var6, int var7) {
      ...
      Arrays.fill(this.aquiferCache, 2147483647);
   ...
   private int computeAquifer(int var1, int var2, int var3) {
      ...
      if (var2 > 30) {
         ...
         boolean var6 = true;
         boolean var7 = true;
         double var8 = this.waterLevelNoise.getValue((double)Math.floorDiv(var1, 64), (double)Math.floorDiv(var2, 40) / 1.4D, (double)Math.floorDiv(var3, 64)) * 30.0D + -12.0D;
