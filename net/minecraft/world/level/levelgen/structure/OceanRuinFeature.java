...
public class OceanRuinFeature extends StructureFeature<OceanRuinConfiguration> {
   ...
   public static class OceanRuinStart extends StructureStart<OceanRuinConfiguration> {
      ...
      public void generatePieces(RegistryAccess var1, ChunkGenerator var2, StructureManager var3, int var4, int var5, Biome var6, OceanRuinConfiguration var7, LevelHeightAccessor var8) {
         int var9 = SectionPos.sectionToBlockCoord(var4);
         int var10 = SectionPos.sectionToBlockCoord(var5);
         BlockPos var11 = new BlockPos(var9, 90, var10);
         Rotation var12 = Rotation.getRandom(this.random);
         OceanRuinPieces.addPieces(var3, var11, var12, this.pieces, this.random, var7);
