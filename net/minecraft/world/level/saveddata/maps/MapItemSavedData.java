...
public class MapItemSavedData extends SavedData {
   ...
   public MapItemSavedData scaled(int var1) {
      return createFresh((double)this.x, (double)this.z, (byte)Mth.clamp(this.scale + var1, 0, 4), this.trackingPosition, this.unlimitedTracking, this.dimension);
   }
   ...
   public void addClientSideDecorations(MapDecoration[] var1) {
      this.decorations.clear();

      for(int var2 = 0; var2 < var1.length; ++var2) {
         MapDecoration var3 = var1[var2];
   ...
   public class HoldingPlayer {
      ...
      // $FF: synthetic method
      HoldingPlayer(Player var2, Object var3) {
         this(var2);
      }
   }
