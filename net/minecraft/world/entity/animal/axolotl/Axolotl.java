...
public class Axolotl extends Animal implements Bucketable {
   public static final Predicate<LivingEntity> NOT_PLAYING_DEAD_SELECTOR = (var0) -> {
      return var0.getType() == EntityType.AXOLOTL && !((Axolotl)var0).isPlayingDead();
   };
   ...
   public boolean hurt(DamageSource var1, float var2) {
      ...
      if (!this.level.isClientSide && !this.isNoAi() && this.level.random.nextInt(3) == 0 && ((float)this.level.random.nextInt(3) < var2 || var3 / this.getMaxHealth() < 0.5F) && var2 < var3 && var1 != DamageSource.DRY_OUT && !this.isPlayingDead()) {
   ...
   public InteractionResult mobInteract(Player var1, InteractionHand var2) {
      return (InteractionResult)ItemUtils.bucketMobPickup(var1, var2, this, SoundEvents.BUCKET_FILL_AXOLOTL, () -> {
   ...
   public void setTarget(@Nullable LivingEntity var1) {
      if (var1 == null) {
         ...
         if (var2 != null && var2.isDeadOrDying()) {
            ...
            if (var3 != null) {
               ...
               if (var4 != null && var4.getType() == EntityType.PLAYER) {
                  ...
                  List var6 = this.level.getEntitiesOfClass(Player.class, this.getBoundingBox().inflate(20.0D));
                  if (var6.contains(var5)) {
                     this.applyRegenEffect(var5);
                  }
               }
            }
         }
      ...
      if (var1 != null && (var1.getType() != EntityType.AXOLOTL || !((Axolotl)var1).isPlayingDead())) {
         super.setTarget(var1);
      }

   }

   public void applyRegenEffect(Player var1) {
      MobEffectInstance var2 = var1.getEffect(MobEffects.REGENERATION);
      int var3 = 100 + (var2 != null ? var2.getDuration() : 0);
      var1.addEffect(new MobEffectInstance(MobEffects.REGENERATION, var3, 0));
   ...
   public static boolean checkAxolotlSpawnRules(EntityType<Axolotl> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      return var1.getFluidState(var3).is(FluidTags.WATER) && !var1.canSeeSkyFromBelowWater(var3);
   }
   ...
   protected void usePlayerItem(Player var1, InteractionHand var2, ItemStack var3) {
      if (var3.is(Items.TROPICAL_FISH_BUCKET)) {
         var1.setItemInHand(var2, BucketItem.getEmptySuccessItem(var3, var1));
      } else {
   ...
   static {
      SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_ADULT, SensorType.HURT_BY, SensorType.AXOLOTL_HOSTILES, SensorType.AXOLOTL_TEMPTATIONS);
